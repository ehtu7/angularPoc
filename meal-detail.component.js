...
var MealDetailComponent = (function () {
    function MealDetailComponent(_route, _router) {
        this._route = _route;
        this._router = _router;
        this.title = 'Welcome to Product Detail';
    }
    MealDetailComponent.prototype.ngOnInit = function () {
        var id = +this._route.snapshot.params['id'];
        this.title += ":" + id;
    };
    MealDetailComponent.prototype.onBack = function () {
...
//# sourceMappingURL=meal-detail.component.js.map